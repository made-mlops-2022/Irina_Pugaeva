...
class Trainer:
    def __init__(self, cfg_path) -> None:
        ...
        pipe = Pipeline([("log_scaler", LogTransformer()), ("clf", self.cfg.model)])
    ...
    def split_data(self, df):
        ...
        X_train, y_train = (
            df_train.drop(columns=[self.cfg.data_params["target_col_name"]]),
            df_train[self.cfg.data_params["target_col_name"]],
        )
        X_test, y_test = (
            df_oos.drop(columns=[self.cfg.data_params["target_col_name"]]),
            df_oos[self.cfg.data_params["target_col_name"]],
        )
